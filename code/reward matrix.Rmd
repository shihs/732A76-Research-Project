...
2. the manpower of begining in period 2 and 3 is 0?
...
count_plot <- function(count, goal_diff, result) {
  # filter goal diff 
  count <- count[which(count$GoalDiff == goal_diff), ]
  
  # plot
  plot(count$interval, count$count, main = paste0(result, ", goal diff = ", goal_diff), xaxt="n")
  ...
  text(x=as.integer(count$interval) - 1,
       y=min(count$count) - (max(count$count)- min(count$count))/10,
...
result <- "win"
par(mfrow=c(1,2))
count_plot(count_120$count_win, 1, result)
count_plot(count_120$count_win, 2, result)
par(mfrow=c(1,2))
count_plot(count_120$count_win, 3, result)
count_plot(count_120$count_win, 4, result)

result <- "lose"
par(mfrow=c(1,2))
count_plot(count_120$count_lose, -1, result)
count_plot(count_120$count_lose, -2, result)
par(mfrow=c(1,2))
count_plot(count_120$count_lose, -3, result)
count_plot(count_120$count_lose, -4, result)


result <- "tied_win"
par(mfrow=c(1,2))
count_plot(count_120$count_tied_win, 1, result)
count_plot(count_120$count_tied_win, 2, result)
result <- "tied_lose"
par(mfrow=c(1,2))
count_plot(count_120$count_tied_lose, -1, result)
count_plot(count_120$count_tied_lose, -2, result)
```
...
result <- "win"
par(mfrow=c(1,2))
count_plot(count_60$count_win, 1, result)
count_plot(count_60$count_win, 2, result)
par(mfrow=c(1,2))
count_plot(count_60$count_win, 3, result)
count_plot(count_60$count_win, 4, result)

result <- "lose"
par(mfrow=c(1,2))
count_plot(count_60$count_lose, -1, result)
count_plot(count_60$count_lose, -2, result)
par(mfrow=c(1,2))
count_plot(count_60$count_lose, -3, result)
count_plot(count_60$count_lose, -4, result)


result <- "tied_win"
par(mfrow=c(1,2))
count_plot(count_60$count_tied_win, 1, result)
count_plot(count_60$count_tied_win, 2, result)
result <- "tied_lose"
par(mfrow=c(1,2))
count_plot(count_60$count_tied_lose, -1, result)
count_plot(count_60$count_tied_lose, -2, result)
```
...
result <- "win"
par(mfrow=c(1,2))
count_plot(count_30$count_win, 1, result)
count_plot(count_30$count_win, 2, result)
par(mfrow=c(1,2))
count_plot(count_30$count_win, 3, result)
count_plot(count_30$count_win, 4, result)

result <- "lose"
par(mfrow=c(1,2))
count_plot(count_30$count_lose, -1, result)
count_plot(count_30$count_lose, -2, result)
par(mfrow=c(1,2))
count_plot(count_30$count_lose, -3, result)
count_plot(count_30$count_lose, -4, result)


result <- "tied_win"
par(mfrow=c(1,2))
count_plot(count_30$count_tied_win, 1, result)
count_plot(count_30$count_tied_win, 2, result)
result <- "tied_lose"
par(mfrow=c(1,2))
count_plot(count_30$count_tied_lose, -1, result)
count_plot(count_30$count_tied_lose, -2, result)
