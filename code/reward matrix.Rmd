...
count_plot <- function(count, groupby = c("GoalDiff", "ManpowerDiff"), diff, result) {
  ...
  # plot
  plot(count$interval, count$count, main = paste0(result, ", ", groupby, " = ", diff), xaxt="n")
  ...
  # text(x=as.integer(count$interval) - 1,
  text(y=min(count$count) - (max(count$count)- min(count$count))/10,
...
# par(mfrow=c(1,2))
# count_plot(count_120$count_lose, "GoalDiff", -3, result)
# count_plot(count_120$count_lose, "GoalDiff", -4, result)
# 
# 
# result <- "tied_win"
# par(mfrow=c(1,2))
...
result <- "win"
par(mfrow=c(1,2))
count_plot(count_60$count_win, "GoalDiff", 1, result)
count_plot(count_60$count_win, "GoalDiff", 2, result)
par(mfrow=c(1,2))
count_plot(count_60$count_win, "GoalDiff", 3, result)
count_plot(count_60$count_win, "GoalDiff", 4, result)

result <- "lose"
par(mfrow=c(1,2))
count_plot(count_60$count_lose, "GoalDiff", -1, result)
count_plot(count_60$count_lose, "GoalDiff", -2, result)
par(mfrow=c(1,2))
count_plot(count_60$count_lose, "GoalDiff", -3, result)
count_plot(count_60$count_lose, "GoalDiff", -4, result)


result <- "tied_win"
par(mfrow=c(1,2))
count_plot(count_60$count_tied_win, "GoalDiff", 1, result)
count_plot(count_60$count_tied_win, "GoalDiff", 2, result)
result <- "tied_lose"
par(mfrow=c(1,2))
count_plot(count_60$count_tied_lose, "GoalDiff", -1, result)
count_plot(count_60$count_tied_lose, "GoalDiff", -2, result)
```
...
result <- "win"
par(mfrow=c(1,2))
count_plot(count_30$count_win, "GoalDiff", 1, result)
count_plot(count_30$count_win, "GoalDiff", 2, result)
par(mfrow=c(1,2))
count_plot(count_30$count_win, "GoalDiff", 3, result)
count_plot(count_30$count_win, "GoalDiff", 4, result)

result <- "lose"
par(mfrow=c(1,2))
count_plot(count_30$count_lose, "GoalDiff", -1, result)
count_plot(count_30$count_lose, "GoalDiff", -2, result)
par(mfrow=c(1,2))
count_plot(count_30$count_lose, "GoalDiff", -3, result)
count_plot(count_30$count_lose, "GoalDiff", -4, result)


result <- "tied_win"
par(mfrow=c(1,2))
count_plot(count_30$count_tied_win, "GoalDiff", 1, result)
count_plot(count_30$count_tied_win, "GoalDiff", 2, result)
result <- "tied_lose"
par(mfrow=c(1,2))
count_plot(count_30$count_tied_los, "GoalDiff", -1, result)
count_plot(count_30$count_tied_lose, "GoalDiff", -2, result)
```
...
result <- "win"
count_plot(count_120$count_win, "ManpowerDiff", 0, result)
par(mfrow=c(1,2))
count_plot(count_120$count_win, "ManpowerDiff", 1, result)
count_plot(count_120$count_win, "ManpowerDiff", 2, result)
par(mfrow=c(1,2))
count_plot(count_120$count_win, "ManpowerDiff", -1, result)
count_plot(count_120$count_win, "ManpowerDiff", -2, result)

result <- "lose"
count_plot(count_120$count_lose, "ManpowerDiff", 0, result)
par(mfrow=c(1,2))
count_plot(count_120$count_lose, "ManpowerDiff", 1, result)
count_plot(count_120$count_lose, "ManpowerDiff", 2, result)
par(mfrow=c(1,2))
count_plot(count_120$count_lose, "ManpowerDiff", -1, result)
count_plot(count_120$count_lose, "ManpowerDiff", -2, result)
...
result <- "tied_win"
count_plot(count_120$count_tied_win, "ManpowerDiff", 0, result)
par(mfrow=c(1,2))
count_plot(count_120$count_tied_win, "ManpowerDiff", 1, result)
count_plot(count_120$count_tied_win, "ManpowerDiff", 2, result)

result <- "tied_lose"
count_plot(count_120$count_tied_lose, "ManpowerDiff", 0, result)
par(mfrow=c(1,2))
count_plot(count_120$count_tied_lose, "ManpowerDiff", -1, result)
count_plot(count_120$count_tied_lose, "ManpowerDiff", -2, result)
```
